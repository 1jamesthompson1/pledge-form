...
export const consentGroups = {
  ...
  conduct: [
    ...
    'Respect the special character of the school',
...
export const eotcStatementsKindergarten = [
  ...
  '{pronoun} acknowledge that to gain a better understanding of the risks involved {pronounLower} can read the available RAMS for each of the destinations (available on the website, in the office, and on noticeboards onsite).',
...
eotcIntro: 'This Education Outside The Classroom (EOTC) form is to cover low risk events which occur during the course of a Kindergarten or School day and are planned to conclude prior to 2:45pm.',
  ...
  eotcKindergartenBlurb: 'During {year}, kaiako will not seek specific consent for local walks with their class. They will inform whānau when an event is planned and seek separate consent for this.<br><br>It is important that this form is completed before the start of the year for all students who will be participating in EOTC events as described above. Details on this form are confidential to kindergarten kaiako and kaiārahi supervising EOTC activities.',
  ...
  splitPaymentTitle: '! Important for separated families !',
  splitPaymentNote: 'The amounts below are the total amounts recommended to be paid for each child. For separated families where both parents contribute, it is left up to the parents/caregivers to agree on how to split the payment. Please only enter what amount you are paying. The school will not be able to advise on what the other parent is paying.',
